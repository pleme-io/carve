  ...
  internal = rec {
    ...
    crates = {
      ...
      "carve" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/carve; };
        authors = [
      ...
      "carve-types" = rec {
        crateName = "carve-types";
        version = "0.1.1";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/carve-types; };
        libName = "carve_types";
        authors = [
          "Pleme Team <team@pleme.io>"
        ];
      ...
      "octocrab" = rec {
        ...
        version = "0.41.2";
        edition = "2018";
        sha256 = "1vzsvbhc8cfnamnb4wqvs3i4avqbdx4n8f0ssy8r9lzvdqgx3pz2";
        authors = [
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "buffer" "futures-core" "futures-util" "pin-project-lite" "retry" "sync_wrapper" "timeout" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "follow-redirect" "futures-util" "map-response-body" "tower" "trace" "tracing" ];
      };
      "tower-layer" = rec {
